...
;
; Move BIOS binary to the destination specified in a1
;
mv_bios:
         move.l   #cpm400_bios_start,a0
         move.w   #cpm400_bios_end-cpm400_bios_start,d0

mv_bios_exec:
         move.b   (a0)+,(a1)+
         dbra     d0,mv_bios_exec
         rts

;
; Move firmware update binary to the destination specified in a1
;
mv_firmware_update:
         move.l   #firmware_update_start,a0
         move.w   #firmware_update_end-firmware_update_start,d0

mv_firmware_update_exec:
         move.b   (a0)+,(a1)+
         dbra     d0,mv_firmware_update_exec
         rts
