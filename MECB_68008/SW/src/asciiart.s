...
*
ffpneg   .equ $210636  * d7=neg(d7)
ffpadd   .equ $210652  * d7=add(d6,d7)
ffpcmp   .equ $210958  * cmp(d6,d7) i.e. d7-d6
ffpifp   .equ $210D42  * d7=int2float(d7)
ffpmul   .equ $210E40  * d7=mul(d6,d7)
ffpafp   .equ $21072A  * d7=ASCII2float(a0)
CR       .equ  $0d
LF       .equ  $0a
*
         .text
