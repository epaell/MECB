...
*****************
          ...
          MOVE.W    #30000,D2             ;SAVE LOOP COUNT
...
*****************
          ...
          MOVE.W    #30000,D2             ;SETUP LOOP COUNT
...
RESULT    BSR       FFPFPA
          ...
          LEA       14+8(SP),A1           ;POINT TO END OF MESSAGE
...
HELLO2    DC.B      '     (C) COPYRIGHT 1981 BY MOTOROLA'
HELLO2E   DC.B      0

MSGADD    DC.B      'THIRTY THOUSAND ADDITIONS OF 3.14159265 TO 2.718281828'
MSGADDE   DC.B      0

MSGMUL    DC.B      'THIRTY THOUSAND MULTIPLIES OF 3.14159265 WITH 2.718281828'
MSGMULE   DC.B      0

MSGDIV    DC.B      'THIRTY THOUSAND DIVIDES OF 3.14159265 INTO 2.718281828'
MSGDIVE   DC.B      0

MSGSQR    DC.B      'TWENTY THOUSAND SQUARE ROOTS OF 3.14159265'
MSGSQRE   DC.B      0

MSGSIN    DC.B      'TEN THOUSAND COSINES AND SINES OF 2.718281828'
MSGSINE   DC.B      0
