...
;
            ...
            library  CPM15KMV             ; copy CPM binary to right location
...
tpaStart    dc.l     $00000400   ; Default: Start of the Transient Program Area
tpaSize     dc.l     $00014c00   ; Default: Size of the Transient Program Area
