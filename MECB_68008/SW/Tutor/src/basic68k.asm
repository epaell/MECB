...
ram_addr	EQU	$08800		* RAM start address just above where Tutor usage ends
ram_size	EQU	$17800		* RAM size
...
ACIA_1   =      SER1        * Console ACIA base address
ACIA_2   =      SER2        * Auxiliary ACIA base address
