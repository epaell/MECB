...
; 5. Type 'SAVE DATE,A100,A2FD,A100' to write the binary file to disk
; 6. Type 'rename DATE.BIN DATE.CMD' to allow the binary to operate as a command
; 7. Test by typing 'DATE' and hit return - it should output the current time and date.
; 8. Make FLEX automatically update the date on startup by creating a startup.txt file
; 9. Type 'build STARTUP.TXT'
; 10. Type 'DATE', press return, type '#' and press return. On boot, FLEX will still ask for a date - just enter 1,1,1
...
GETDAT   jsr   INDEC       ; Input a number
         ...
         andcc #$fe        ; indicate no errors (clear carry)
         rts
GETDA3   orcc  #$01        ; Error flag (set carry)
GETDA4   rts
;
; Print the date
;
...
PDAT1    deca
         beq   PDAT3
PDAT2    leax  1,x         ; find month string
         tst   0,X
         bne   PDAT2
         leax  1,x
         bra   PDAT1
