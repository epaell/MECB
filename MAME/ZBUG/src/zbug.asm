...
; This works
;RAM           EQU $003000       ; RAM START ADDRESS
;SUPER_STACK   EQU $130000       ; SUPER STACK TOP Address
;ACIAC         EQU $600000
;
...
;
   ORG $000000
   ; Reset start vector
   DC.L SUPER_STACK        ; TOP OF SUPERVISOR STACK
   ...
   ORG $C0
RAMBASE  DC.L   RAM     ; RAM BASE ADDRESS
...
TITLE  DC.B 13,10,'zBug V1.0.1 for MECB 68008',13,10,0
TITLE1 DC.B 13,10,'zBug V1.0.1 for MECB 68008 (press ? for help)',13,10,0
...
ABOUTZBUG DC.B 'bout zBuG V1.0',13,10,10
          ...
          DC.B 'zBug V1.0.1 MECB 68008 Version by @epaell',13,10,0
...
;RAMBASE     DC.L   $003000     ; RAM BASE ADDRESS
