...
class mecb68008b_state : public driver_device
{
public:
	mecb68008b_state(const machine_config &mconfig, device_type type, const char *tag)
	...
	void mecb68008b(machine_config &config);

private:
	void mecb68008b_mem(address_map &map);
...
void mecb68008b_state::mecb68008b(machine_config &config)
{
	/* basic machine hardware */
	M68008(config, m_maincpu, XTAL(8'000'000));
	m_maincpu->set_addrmap(AS_PROGRAM, &mecb68008b_state::mecb68008b_mem);
...
ROM_START(mecb68008b)
	...
	ROM_LOAD("mecb68008b.bin",   0x00000, 0x8000, CRC(9d741375) SHA1(727b5e219c60a0330e6d11061d3e77d67d190c8b) )
ROM_END
...
COMP( 2024, mecb68008b,      0,        0,      mecb68008b, 0,  mecb68008b_state, empty_init,    "DigicoolThings",   "MECB 68008 BASIC",  MACHINE_NO_SOUND_HW )
