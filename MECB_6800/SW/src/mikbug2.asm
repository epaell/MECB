...
*
*
       ORG    RAMORG   START OF RAM .
NBRBPT EQU    8        # OF BREAKPOINTS SUPPORTED
*
* THE FOLLOWING ARE INITIALIZED AT START
*
IOV    ds.b   2        I/O INTERRUPT POINTER
BEGA   ds.b   2        BEGIN ADDRESS PRINT/PUNCH
ENDA   ds.b   2        END ADDRESS PRINT/PUNCH
NIO    ds.b   2        NMI INTERRUPT POINTER
SP     ds.b   2        USER STACK POINTER
SWI1   ds.b   2        LEVEL 1 SWI VECTOR
SWI2   ds.b   2        LEVEL 2 SWI VECTOR
BRINS  ds.b   8        STORAGE FOR CONDITIONAL BRANCH
*                            ROUTINE
...
*
*
OUTSW  ds.b   1        OUTPUT SWITCH
*                       (ZERO => ECHO INPUT)
TRCADR ds.b   2        TRACE ADDRESS
TRCINS ds.b   1        OP CODE REPLACED BY SWI
NTRACE ds.b   2        NO. OF INSTRUCTIONS TO TRACE
*
BRKADR ds.b   NBRBPT*2 BREAKPOINT ADDRESS TABLE
BRKINS ds.b   NBRBPT*2 OP CODES FOR BREAK REPLACEMENT
*                            (UPPER BYTE OF EACH
*                             PAIR USED ONLY)
CKSM   EQU    *        CHECKSUM
...
*
*
XHI    ds.b   1        X REG HIGH (TEMP)
XLOW   ds.b   1        X REG LOW
*
*
...
*
*
BRKSIN ds.b   1        1=>BREAKS ARE IN USER PROGRAM
*
BRKTRC ds.b   1	       1=>P-COUNTER IS AT BREAKPOINT
*                      AND USER WANTS TO CONTINUE-
*                      ONE TRACE WILL BE DONE AND
*                      BREAKPOINT RESTORED
ENDIN0 EQU    STACK+8  END OF VAR'S INTZ'D to 0
*
ACIAT  ds.b   1        SAVE ACIS CONTROL REG FOR
...
STARTP ds.b   1
STOPPG ds.b   1
TOTCNT ds.b   1        WINDOW WIDTH
PATDEL ds.b   1        PATTERN-ELEMENT LENGTH
CL     ds.b   1        CHECK/LOAD SUB
CLL    ds.b   1
CLLL   ds.b   1        RTS
*TAPE TEMPORARIES
H      ds.b   1        LOAD IX, ETC.
L      ds.b   1
Q      ds.b   1        Q HOLDS LAST BYTE RECOVERED
R      ds.b   1        R,S IS CRC REGISTER
S      ds.b   1
V      ds.b   1        PAGE COUNT
T1     EQU    CL
*
...
*
       ds.b   36
STACK  ds.b   1        START OF STACK AREA