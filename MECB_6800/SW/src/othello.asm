...
XXOO   dc.b   'O'
WAIT   dc.b   0         NO WAIT
STRTGY dc.b   2         BEST STRATEGY
WHO1ST dc.b   1         HUMAN FIRST
COUNT  ds.b   1
TEMPX1 ds.b   2
TEMP1  ds.b   1
RDIR   ds.b   1
...
RTS2   RTS
NEIBOR dc.b   0,1       DOWN
       dc.b   $FF,1     LOWER-LEFT
       dc.b   $FF,0     LEFT
       dc.b   $FF,$FF   UPPER-LEFT
       dc.b   0,$FF     UP
       dc.b   1,$FF     UPPER-RIGHT
       dc.b   1,0       RIGHT
       dc.b   1,1       LOWER RIGHT
...
GREET  dc.b   '/^^^'
       dc.b   'GREETINGS FROM OTHELLO/'
INST0  dc.b   'DO YOU WANT INSTRUCTIONS?;'
INST1  dc.b   '//OTHELLO IS PLAYED ON AN '
       dc.b   '8 BY 8 CHECKER BOARD WITH '
       dc.b   '/ROWS NUMBERED 1 TO 8 '
       dc.b   'AND COLUMNS A TO H.'
       dc.b   '/THE INITIAL CONFIGURATION '
       dc.b   'IS ALL BLANK EXCEPT'
       dc.b   '/FOR THE CENTER FOUR SQUARES, '
       dc.b   'WHICH FORM THE PATTERN:/'
       dc.b   '          O X/'
       dc.b   '          X O/'
       dc.b   'PUT YOUR PIECE SO THAT MINE IS '
       dc.b   'BETWEEN 2 OF YOURS, SUCH AS:/'
       dc.b   '        X O X/'
       dc.b   '          X O/'
       dc.b   'THIS WILL "FLIP" MY TOP "O" INTO YOUR "X"/'
       dc.b   '/NOTE: YOU MAY CAPTURE 1 OR MORE OF '
       dc.b   'MY PIECES THIS WAY,/'
       dc.b   'OR YOU MAY FORFEIT BY TYPING "Z"'
IWAIT  dc.b   '//SHOULD I WAIT BEFORE '
       dc.b   'MAKING MY MOVES?;'
OKWAIT dc.b   '/OK. TYPING ANY CHARACTER '
       dc.b   'WILL LET ME GO!/;'
BEST   dc.b   '/SHOULD I PLAY MY BEST '
       dc.b   'STRATEGY?;'
SORRY  dc.b   '/SORRY, THAT SQUARE IS '
       dc.b   'OCCUPIED. TRY AGAIN!;'
MOVE   dc.b   '/YOUR MOVE--(ROW,COL)?;'
XORO   dc.b   '/DO YOU WANT TO HAVE X OR O?;'
FIRST  dc.b   '/DO YOU WANT TO GO FIRST?;'
NONEXT dc.b   '/SORRY, YOU ARE NOT NEXT TO '
       dc.b   'ONE OF MY PIECES. TRY AGAIN!;'
NOFLNK dc.b   '/SORRY, THAT MOVE DOES NOT '
       dc.b   'FLANK A ROW. TRY AGAIN!;'
THAT   dc.b   '^/THAT GIVES YOU ;'
OFMY   dc.b   ' OF MY PIECES/;'
YOUHAV dc.b   7
       dc.b   'YOU HAVE ;'
ANDI   dc.b   ' PIECES AND I HAVE ;'
PTEXT  dc.b   ' PIECES!/;'
IWON   dc.b   'SORRY, I WON THAT ONE!/;'
ATIE   dc.b   'A TIE!/;'
MEWON  dc.b   'YOU WON!!/;'
TTYPE  dc.b   'THAT WAS A ;'
PERFCT dc.b   'PERFECT GAME!/;'
WALK   dc.b   'WALKAWAY!/;'
FIGHT  dc.b   'FIGHT!/;'
HOT    dc.b   'HOT GAME!/;'
SQEAK  dc.b   'SQUEAKER!/;'
ANOTHR dc.b   '/DO YOU WANT TO PLAY'
       dc.b   ' ANOTHER GAME?;'
THANX  dc.b   '/THANKS FOR PLAYING!/;'
IMOVE  dc.b   '^^I MOVE TO ;'
THAT1  dc.b   '/THAT GIVES ME ;'
YOUR   dc.b   ' OF YOUR PIECES./;'
CPU0   dc.b   'I HAVE TO FORFIT MY MOVE!/;'
HUM0   dc.b   '/ARE YOU FORFEITING '
       dc.b   'YOUR TURN (Y OR N)?;'
LETTER dc.b   '/  A B C D E F G H/;'
