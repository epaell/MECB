...
DAMTRB   EQU   $68
DAMCOM   EQU   $69
PCOUNT   EQU   $6A      ; TORP SPREAD COUNT
PTZFLG   EQU   $6B      ; NO MORE TORP FLAG
GAMEND   EQU   $6C
AUTOSR   EQU   $6D
AUTOLR   EQU   $6E
SUPFLG   EQU   $6F
TELFLG   EQU   $70
ATKENG   EQU   $71
QUDPTR   EQU   $73      ; POINTS TO CURR LOC IN QUDMAP
PASWRD   EQU   $75
PHTFLG   EQU   $78
SHUTCR   EQU   $79
SHUTLX   EQU   $7A
SHUTLY   EQU   $7B
QUDMAP   EQU   $7C
COMMAP   EQU   $BC      ; MUST FOLLOW QUDMAP IMMEDIATELY
SECMAP   EQU   $FC      ; PACKED SECTOR (64*2 BITS) 00=., 01=*, 10=K, 11=B
STUF     EQU   $010C    ; SEED FOR RANDOM FUNCTION

STACK    EQU   $7F42    ; STACK
...
OUTCH    PSHB                 SAVE ACC B
ACIOU1   LDAB  CTLPOR
         ASRB
         ASRB
         BCC   ACIOU1         ACIA NOT READY
         STAA  CTLPOR+1       OUTPUT CHARACTER
